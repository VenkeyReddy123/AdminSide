                ...
                <table className="table table-striped mt-2">
                    <thead>
                        <tr>
                            ...
                            <td><small>Exchange Quantity</small></td>
                            ...
                            return (
                                <>
                                    <tr>
                                        ...
                                        {/* <td style={{ textWrap: 'nowrap' }}><small>{order.Delivary == 'No' ? <><small><i class="fa-solid fa-xmark text-danger"></i></small>:</><i onClick={() => {
                                    DelivaryStatus(order)
                                }} class="fa-solid fa-check ml-2 text-dark btn  p-1"></i></>}</small></td> */}
                                    <td>{order.Delivary=='No'?<i onClick={() => {DelivaryStatus(order)}} class="fa-solid fa-check ml-2 text-success btn  p-1"></i>:<><small className='text-primary' style={{}}>Yes</small></>}</td>
                                    </tr>
                                </>
                            )
                        })}
...
const ExchangePage = () => {
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:8000/ExchangeDetailsView2/').then((d) => {
            SetData(d.data)
        }).catch((e) => {
